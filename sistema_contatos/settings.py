...
SECRET_KEY = 'django-insecure-chave-temporaria-12345'
...
DATABASES = {
    'default': {
        ...
        # NO FINAL do arquivo, ANTES do fechamento, adicione:
...
# Se tiver variável de ambiente DATABASE_URL (Render fornece)
